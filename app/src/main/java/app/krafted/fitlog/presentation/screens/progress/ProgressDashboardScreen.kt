...
import app.krafted.fitlog.presentation.screens.progress.components.MetricCard
import app.krafted.fitlog.presentation.screens.progress.components.VolumeTrendChart
import app.krafted.fitlog.presentation.screens.progress.components.WorkoutFrequencyChart
...
private fun ProgressDashboardContent(
    ...
    onDateRangeSelected: (app.krafted.fitlog.domain.model.DateRangeFilter) -> Unit,
    onNavigateToBodyweight: () -> Unit,
    modifier: Modifier = Modifier
) {
