package app.krafted.fitlog.presentation.screens.routines
...
import app.krafted.fitlog.presentation.viewmodel.RoutineNavigationEvent
import app.krafted.fitlog.presentation.viewmodel.RoutineViewModel
                    ...
                    LazyColumn(
                        ...
                        item {
                            ...
                            Button(
                                onClick = { 
                                    if (routineId != 0) {
                                        navController.navigate(app.krafted.fitlog.presentation.navigation.FitLogRoutes.exercisePicker(routineId))
                                    } else {
